...
// =========================
// VALIDATE PROMO CODE
// ⚠️ Must be defined BEFORE /:id to avoid being matched as id="validate"
// =========================
...
app.post("/", authMiddleware, adminOnly, async (c) => {
  ...
  const promo = await db
    ...
    .values({
      ...
      expiresAt: body.expiresAt || null,   // ✅ convert "" to null
      isActive: body.isActive ?? true,     // ✅ respect form value
    })
    .returning();
