  ...
  export function EditSpace() {
    ...
    useEffect(() => {
      const getSpace = async () => {
        ...
        console.log("PRICE:", data.pricePerHour);
        ...
        setFormData({
          nama: data.name || "",
          kategori: data.type || "",
          kapasitas: String(data.capacity || ""),
          deskripsi: data.description || "",
          alamat: data.address || "",
          hargaDasar: String(data.pricePerHour || ""),
          depositJaminan: String(data.deposit || ""),
        });
      };
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
      ...
      const payload = {
        ...
        pricePerHour: Number(formData.hargaDasar),
        deposit: Number(formData.depositJaminan),
      };
      ...
      <div className="flex h-screen bg-zinc-50"> 
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <button onClick={() => window.location.href = '/space_admin'} className="flex items-center gap-2 text-zinc-500 hover:text-zinc-900 mb-6 font-medium transition-colors">
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        placeholder="Contoh: Studio Foto Minimalis"
                        value={formData.nama}
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, depositJaminan: e.target.value })}
                        required
                      />
                    </div>
